...
const LoginForm = () => {
  ...
  return (
    // bubble background
    <div className='flex items-center justify-center h-[100dvh] bg-gray-100 dark:bg-gray-900 overflow-hidden items-center relative'>
      ...
      <StyledWrapper>
        <form onSubmit={submitHandler} className="form">
          ...
          <div id="email-area">
            <input onChange={changeHandler} name="email" placeholder="EMAIL" id="email" className="input" type="email" />
          </div>
          <div id="password-area">
            <input onChange={changeHandler} name="password" placeholder="PASSWORD" id="password" className="input" type="password" />
            <a></a>
          </div>
          <div id="footer-area">
